...
public final class Commons {
  ...
  public static final int TRACING_ENABLED = Commons.getIntEnv("TRACING_ENABLED", 1);
  ...
  public static Vertx vertx() {
    ...
    tracer.ifPresent(t -> opts.setTracingOptions(new OpenTracingOptions(t).setEnabled(true)));
